...
const parts = {
	tl: 'thinboard_corner_lefttop',
	tr: 'thinboard_corner_righttop',
	bl: 'thinboard_corner_leftbottom',
	br: 'thinboard_corner_rightbottom',
	t: 'thinboard_line_top',
	b: 'thinboard_line_bottom',
	l: 'thinboard_line_left',
	r: 'thinboard_line_right',
}
...
await sharp({ create: { width: 48, height: 48, channels: 4, background: { r: 0, g: 0, b: 0, alpha: 0 } } })
	.composite([
		{ input: buf.tl, left: 0, top: 0 },
		{ input: buf.t, left: 16, top: 0 },
		{ input: buf.tr, left: 32, top: 0 },
		{ input: buf.l, left: 0, top: 16 }, /* center stays transparent */
		{ input: buf.r, left: 32, top: 16 },
		{ input: buf.bl, left: 0, top: 32 },
		{ input: buf.b, left: 16, top: 32 },
		{ input: buf.br, left: 32, top: 32 },
	])
	.webp({ lossless: true })
